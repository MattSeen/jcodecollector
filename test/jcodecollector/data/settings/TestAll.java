...
public class TestAll {
    ...
    public static Test suite() {
        ...
        suite = new TestSuite("Tests in package jcodecollector.data.settings");
        suite.addTestSuite(ApplicationSettingsManagerTest.class);
        suite.addTestSuite(ApplicationSettingsTest.class);
        return suite;
    }
}
