...
public class ApplicationSettings {
    ...
    static {
        String userDirectory = FileSystemView.getFileSystemView().getDefaultDirectory()
                .getAbsolutePath();
        if (OS.isMacOSX()) {
            DATABASE_PATH_DEFAULT = userDirectory + "/Library/Application Support/";
            PREFERENCES_PATH_DEFAULT = userDirectory
                    + "/Library/Preferences/com.alessandro.jcodecollector";
        } else {
